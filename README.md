...
| Dockets | 180,426 |
| Case documents | 3,433,888 |
| Docket entries | 6,829,066 |
| Archive size | 68,462 MB |
| Latest tentative ruling | 2026-05-22 |

Generated by `update-readme.py` from `data/manifest.json` and the companion
data repository's archive indexes. Refresh with `python update-readme.py
--live-counts-only`.
